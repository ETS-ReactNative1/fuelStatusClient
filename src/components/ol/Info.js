        ...
        >
        	...
        	<ul className="list-group" id="history" ref={ulNode => this.getHeight(ulNode)}>
        		...
        		<li className='list-group-item'>ERC 48 hours ago: {zoneData.ERC48}</li>
					...
					/>
					<div className="card-block rounded" style={{backgroundColor: '#ccc'}}>
        	Fuel values based on 3-day averages. During rapidly changing weather conditions, this fuel map may not be representative.  Fuel values are observed at 1300  Local Time and weather after that will not be incorporated into fuel calculations. During such times, please coordinate with Predictive Services for fuel guidance.
  			</div>
  			</div> 
  		</div>
		)
