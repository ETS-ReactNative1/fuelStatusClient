...
class Header extends Component {
  componentDidMount() {
    ...
    console.log('asdfasdfasdfasdf', this.props.fetchStatus())
  }	
	renderLinks = () => {
			  ...
			  <div className="navbar" id="navbarNavAltMarkup">
			    <div className="navbar-nav">
					...
					<img src="./PSlogo.png" 
						...
						alt="responsive logo" 
					/>
					<span style={{color:'white', fontSize:'10px', textAlign:'center'}}>*** MAP MAY BE UNREPRESENTATIVE IN RAPIDLY CHANGING CONDITIONS ***<br />***  DURING SUCH EVENTS AS SIGNIFICANT RAIN OR RAPID DRYING, CONTACT PREDICTIVE SERVICES FOR FUEL GUIDANCE ***</span>
			</nav>
		)
  }
}
