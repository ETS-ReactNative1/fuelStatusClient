...
//local storage token "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJzdWIiOiI1OTNmNTg0NjJjZTg4NzMxMTQ5ZTJjOGEiLCJpYXQiOjE1ODkyMjc1ODM5MzZ9.qH6t4jHTISGqor2NIKzzwLZqQAoTKoeHBPxWOz06ncI"
const ROOT_URL = 'http://localhost:3090/server'
	...
	return function(dispatch) {
		axios({ 
		  ...
		  data: formData,
			...
			.catch(error => console.log('update zone error', error))
	}
}
...
export function fetchStatus() {
	return function(dispatch) {
		...
		axios.get(`${ROOT_URL}/status`)
			...
			.catch(error => console.log('fetch status error', error))		
	}
}
